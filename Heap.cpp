...
public:
    StudentForHeap(int studentId, string studentName, double studentGpa, string studentDepartment)
...
private:
    vector<StudentForHeap> students;
...
public:
    ...
    void loadStudents(string filename) {
        ...
        for (int i = 0; i < numStudents; i++) {
            ...
            addStudent(StudentForHeap(id, name, gpa, department));
        }
    ...
    void printHeap() {
        ...
        // Print the students
        for (StudentForHeap student: students) {
    ...
    void addStudent(StudentForHeap student) {
    ...
    do {
        ...
        switch (subChoice) {
            case 1: {
                ...
                minHeap.addStudent(StudentForHeap(id, name, gpa, department));
    ...
    do {
        ...
        switch (subChoice) {
            case 1: {
                ...
                maxHeap.addStudent(StudentForHeap(id, name, gpa, department));
                cout << "\nStudent added successfully!" << endl;
